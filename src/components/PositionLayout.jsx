// src/components/PositionLayout.jsx
import React, { useState, useEffect } from 'react';
import PositionSettingsPanel from './PositionSettingsPanel';
import PositionVictimParent from './PositionVictimParent';
import PositionIndividualSettingsModal from './PositionIndividualSettingsModal';
import './PositionLayout.css';
...
const PositionLayout = () => {
  ...
  return (
    <div className="position-layout-container">
      ...
      {selectedElementId && (
        <PositionIndividualSettingsModal
